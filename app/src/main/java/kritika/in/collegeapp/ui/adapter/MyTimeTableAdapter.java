...
public class MyTimeTableAdapter extends RecyclerView
        .Adapter<MyTimeTableAdapter
        .subjectsHolder> {
    ...
    public static class subjectsHolder extends RecyclerView.ViewHolder
            implements View
            .OnClickListener {
        TextView sub_name_timetable;

        public subjectsHolder(View itemView) {
            super(itemView);
            sub_name_timetable = (TextView) itemView.findViewById(R.id.sub_name_timetable);
    ...
    public MyTimeTableAdapter(ArrayList<subjects> myDataset) {
        dataset = myDataset;
    }
    ...
    public subjectsHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.homepage_timetable_singleview_item, parent, false);
    ...
    public void onBindViewHolder(subjectsHolder holder, int position) {
        holder.sub_name_timetable.setText(dataset.get(position).getSub_name());
